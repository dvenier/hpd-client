...
public class HPDObjectWithNoUIDException extends RuntimeException {

    private static final long serialVersionUID = -7204327928232093989L;

    public HPDObjectWithNoUIDException() {
    }

    public HPDObjectWithNoUIDException(String msg) {
        super(msg);
    }
}
