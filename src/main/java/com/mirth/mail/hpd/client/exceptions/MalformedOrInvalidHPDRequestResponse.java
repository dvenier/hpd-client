...
public class MalformedOrInvalidHPDRequestResponse extends Exception {

        private static final long serialVersionUID = -2001294286011825511L;

        public MalformedOrInvalidHPDRequestResponse() {
        }

        public MalformedOrInvalidHPDRequestResponse(String msg) {
            super(msg);
        }
    }
