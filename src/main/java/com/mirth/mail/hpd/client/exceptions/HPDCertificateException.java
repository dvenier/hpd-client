...
public class HPDCertificateException extends RuntimeException {

    private static final long serialVersionUID = -7155447744258682003L;

    public HPDCertificateException() {
    }

    public HPDCertificateException(String msg) {
        super(msg);
    }
}
