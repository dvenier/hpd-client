...
public class HPDRequestTimeoutException extends Exception {

        private static final long serialVersionUID = 5167432268231439276L;

        public HPDRequestTimeoutException() {
        }

        public HPDRequestTimeoutException(String msg) {
            super(msg);
        }
    }
