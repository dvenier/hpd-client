...
public class HPDSearchRequest implements Serializable {
    ...
    public boolean hasSearchCriteria() {
        return HPDUtil.isNotBlank(uid) || HPDUtil.isNotBlank(nameSearchText) || HPDUtil.isNotBlank(npi) || HPDUtil.isNotBlank(specializationText) || 
               HPDUtil.isNotBlank(specializationCode) || HPDUtil.isNotBlank(gender) || HPDUtil.isNotBlank(lastName) || HPDUtil.isNotBlank(firstName) || 
               HPDUtil.isNotBlank(emailAddress) || HPDUtil.isNotBlank(serviceAddressText) || HPDUtil.isNotBlank(addressSearchText) || 
               ...
               HPDUtil.isNotBlank(stateOrProvinceName) || HPDUtil.isNotBlank(serviceAddressText) || 
    ...
    public String toDSMLSearchString(HPDInstanceModel hpdInstance) {
        ...
        if (HPDUtil.isNotBlank(getAddressSearchText())) {
    ...
    public final String toDSML(HPDInstanceModel hpd, HPDClientConfig config) {
        ...
        String batchRequest = String.format(requestBody, soapActionRequestUUID, batchRequestId, String.format(searchRequestBody, baseDNOffset, hpd.getBaseDN(), dsmlScope, searchRequetID, toDSMLSearchString(hpd)));
